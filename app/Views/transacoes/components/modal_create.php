            ...
            <div class="modal-body p-4">
                ...
                <ul class="nav nav-pills nav-fill mb-4" id="pills-tab" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active bg-danger-soft text-danger fw-bold border border-danger"
                            id="aba-despesa-tab" data-bs-toggle="pill" data-bs-target="#aba-despesa" type="button"
                            role="tab">
                            <i class="bi bi-arrow-down-circle me-2"></i> Despesa
                        </button>
                    </li>
                    <li class="nav-item ms-2" role="presentation">
                        <button class="nav-link bg-success-soft text-success fw-bold border border-success"
                            id="aba-receita-tab" data-bs-toggle="pill" data-bs-target="#aba-receita" type="button"
                            role="tab">
...
<style>
    ...
    .nav-pills .nav-link.text-danger.active { background-color: #dc3545 !important; }
    .nav-pills .nav-link.text-success.active { background-color: #198754 !important; }
</style>