            ...
            <?php foreach ($transacoes as $t): ?>
              <tr>
                ...
                <td class="text-center pe-4">
                  <a href="<?php echo base_url('transacoes/excluir/' . $t->id) ?>" class="btn btn-sm btn-outline-danger"
                    title="Excluir" onclick="return confirm('Tem certeza que deseja apagar este lançamento?');">
                    Excluir
                  </a>
                </td>
              </tr>
