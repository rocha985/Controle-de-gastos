...
<body class="bg-light">
  ...
  <nav class="navbar navbar-dark bg-dark shadow-sm d-lg-none px-3 navbar-mobile">
    <div class="container-fluid d-flex align-items-center justify-content-between">
      <button class="btn btn-outline-light border-0 ms-auto" type="button" data-bs-toggle="collapse"
  ...
  <div class="wrapper">
    ...
    <aside class="sidebar bg-dark text-white shadow collapse d-lg-flex flex-column" id="sidebarMenu">
      ...
      <nav class="mt-3 mb-3 nav flex-column flex-grow-1 px-3 pt-3 pt-lg-0">
        <a class="nav-link rounded mb-2 text-white-50 <?php echo (isset($active) && $active == 'lancamentos' ? ' active text-white fw-bold bg-white bg-opacity-10' : '') ?>"
        ...
        <div
          class="nav-link rounded mb-1 d-flex justify-content-between align-items-center <?php echo $isRelatorio ? 'text-white' : 'text-white-50' ?>">
        ...
        <div id="submenuRelatorios" class="ms-3 border-start border-secondary border-opacity-25">
          <div class="card card-body bg-transparent border-0 py-0 ps-3">
            ...
            <a href="<?php echo base_url('relatorios/mensal') ?>"
              class="nav-link small mb-1 rounded <?php echo (isset($active) && $active == 'relatorios-mensal') ? 'bg-white bg-opacity-10 text-white fw-bold' : 'text-white-50' ?>">
              Mensal
            </a>

            <a href="<?php echo base_url('relatorios') ?>"
              class="nav-link small mb-1 rounded <?php echo (isset($active) && $active == 'relatorios-anual') ? 'bg-white bg-opacity-10 text-white fw-bold' : 'text-white-50' ?>">
              Anual
            </a>

            <a href="<?php echo base_url('relatorios/geral') ?>"
              class="nav-link small mb-1 rounded <?php echo (isset($active) && $active == 'relatorios-geral') ? 'bg-white bg-opacity-10 text-white fw-bold' : 'text-white-50' ?>">
              Visão Geral
            </a>
      ...
      <div class="mt-auto border-top border-secondary p-3">
        <div class="d-flex align-items-center justify-content-between">
          <div class="d-flex align-items-center overflow-hidden">
            <div
              class="bg-primary rounded-circle d-flex align-items-center justify-content-center text-white me-2 flex-shrink-0"
